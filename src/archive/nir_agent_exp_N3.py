...
# Hypothesis: The dominant bottleneck is sp15, characterized by catastrophic underprediction at high MC values (>150%).
# To address this, we will apply sample weighting during training, giving higher importance to samples from sp15
# and samples with high moisture content (MC > 150%), especially those that are both sp15 and high MC.

# Target transformation: I2 default is sqrt(y)
y_sqrt =