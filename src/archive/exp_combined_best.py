"""Experiment: Combine best hyperparameter findings
- path_smooth=10: LOSO=-0.10 vs P1
- max_bin=127: LOSO=-0.003 vs P1
- leaves=47: LOSO=-0.038 vs P1
Test all combinations to see if they compound.
"""
import numpy as np
import pandas as pd
...
configs = [
    {"label": "P1 baseline", "leaves": 63, "mb": 255, "ps": 0},
    {"label": "ps=10 only", "leaves": 63, "mb": 255, "ps": 10},
    {"label": "mb=127 only", "leaves": 63, "mb": 127, "ps": 0},
    {"label": "lv=47 only", "leaves": 47, "mb": 255, "ps": 0},
    {"label": "ps=10+mb=127", "leaves": 63, "mb": 127, "ps": 10},
    {"label": "ps=10+lv=47", "leaves": 47, "mb": 255, "ps": 10},
    {"label": "mb=127+lv=47", "leaves": 47, "mb": 127, "ps": 0},
    {"label": "ALL THREE", "leaves": 47, "mb": 127, "ps": 10},
    {"label": "ps=5+mb=127+lv=47", "leaves": 47, "mb": 127, "ps": 5},
    {"label": "ps=15+mb=127+lv=47", "leaves": 47, "mb": 127, "ps": 15},
    {"label": "ps=10+mb=127+lv=55", "leaves": 55, "mb": 127, "ps": 10},
]
...
for cfg in configs:
    LGBM_PARAMS = dict(
        ...
        random_state=42, learning_rate=0.02, num_leaves=cfg["leaves"],
...
if best_test is not None:
    ...
    sub.to_csv(OUTPUT_DIR / "submission_exp_combined_best.csv", index=False, header=False)
    print(f"Saved best submission: {OUTPUT_DIR / 'submission_exp_combined_best.csv'}")
